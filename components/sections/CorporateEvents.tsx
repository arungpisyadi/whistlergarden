...
const CorporateEvents = ({ className }: CorporateEventsProps) => {
...
return (
    <section id="corporate" className={`section-padding bg-white ${className}`}>
    <div className="container-custom">
        ...
        <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Have your company events in a memorable place that offer great vibe for your team or guests
        </p>
        </div>

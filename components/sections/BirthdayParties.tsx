...
interface BirthdayPartiesProps {
  className?: string
}

const BirthdayParties = ({ className }: BirthdayPartiesProps) => {
  // Birthday party images with captions
  const birthdayEvents = [
    ...
    {
      id: 3,
      src: '/images/birthday/ROYALE_BIRTHDAY KIDS-2.jpg',
      alt: 'Royal Birthday Theme',
      title: 'Themed Birthday Parties',
      description: 'Transform your celebration with our custom themed party packages and decorations.',
    }
  ]
  ...
  return (
    <section id="birthday" className={`section-padding bg-primary-100 ${className}`}>
      <div className="container-custom">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Celebrate your birthday or your loved ones in a place where it will lasts forever in the memory.
          </p>
        </div>

        {/* Birthday Events Vertical Layout */}
